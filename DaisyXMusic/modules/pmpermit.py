    ...
    if PMPERMIT == "ENABLE":
        if PMSET:
            ...
            await USER.send_message(
                message.chat.id,
                "Hi there, This is a free BATCH extract service .\n\n ❗️ Rules:\n   - No chatting allowed\n   - No spam allowed \n\n 👉 **SEND ID PASSWORD AND BATCH NAME.**\n\n ⚠️ Disclamer: If you are sending a message here it means admin will see your message reply you soon\n    - Don't add this user to secret groups.\n   - Don't Share private info here\n\n",
            )
            return
